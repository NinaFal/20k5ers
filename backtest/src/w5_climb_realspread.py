#!/usr/bin/env python3
"""
Het klimjaar 2015 met REALISTISCHE spreads — variant van w5_climb_candidate.

Zelfde code, maar de kostentabel komt uit SLIPPAGE_MAP en de uitvoer uit
W5_CLIMB_OUT, zodat deze meting de eerste niet overschrijft.
...
OUT = w5.W5_DIR / os.getenv("W5_CLIMB_OUT", "climb_candidate.json")
# De kostentabel mag uit de omgeving komen. Nodig omdat de eerste meting op
# spread_map() draaide, die 4,5 pip rekent op vijf crosses waar de live bot bij
# meer dan 3,0 pip weigert te openen — te duur, en afgerekend op trades die niet
# zouden bestaan. Zonder SLIPPAGE_MAP in de omgeving verandert er niets.
...
ARMS = {"nu": (False, True, False), "kand": (True, True, False),
        "nu_spx": (False, True, True), "kand_spx": (True, True, True)}
