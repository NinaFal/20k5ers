...
| 5 | survival-zoektocht | **AFGEROND EN NEGATIEF.** 46 van 80 trials; de rest is niet gedraaid omdat de top vijf allemaal op 1,6-1,8% risico uitkwam. Kandidaat trial 31 scoorde op de 30 case-enriched screenvensters 1 breach tegen 7 voor de incumbent. Op de 68 ACHTERGEHOUDEN vensters is het **2 tegen 2, met nul overlap**: de incumbent valt om op 2016-09-01 en 2022-07-06, de kandidaat op 2015-01-08 en 2016-02-29. McNemar p = 1,000. Hij ruilt twee mislukkingen in voor twee andere. Dat is de winner's curse die in de kop van w5_confirm_candidate.py staat beschreven, en dezelfde val die de vorige basisconfiguratie op 0/25 zette en daarna op 7/100. **Voor de challenge is er geen reden om te wisselen** — de mediaan wordt zelfs 2 dagen trager (21 tegen 19). Wat WEL blijft staan is losse data: op het GEFUNDE elfjarige pad met kosten leeft de kandidaat 11/11 jaar met een ergste dag van 4,08% waar de incumbent in augustus 2015 omvalt bij 6,13%. Twee fases, twee bindende beperkingen |
