...
**CRITICAL**: The `main_live_bot.py` backtest consists of TWO stages:
...
| `scripts/simulate_main_live_bot.py` | H1 simulation matching `main_live_bot.py` EXACTLY |
...
# Stage 2: Simulate with H1 execution
