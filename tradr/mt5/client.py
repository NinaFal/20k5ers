...
class MT5Client:
    ...
    def get_ohlcv(
        ...
        # First, ensure symbol is selected/enabled in Market Watch
        ...
        if thread.is_alive():
            print(f"[MT5] Timeout fetching {symbol} {timeframe} data after {timeout_seconds}s")
            return []
        
        try:
            rates = result_queue.get_nowait()
        except queue.Empty:
            return []
